...
const InternalConfig = function(initConfig) { // eslint-disable-line no-unused-vars
    const cfg = /** @lends {InternalConfig.prototype} */ {
         ...
         * @param {string} path The path that Pandemonium's wants executed.
         ...
         * @param {number} status_code The status code returned by Pandemonium on exit.
         */
        /**
         * @ignore
     ...
     */
    Config.prototype.getPandemoniumConfig = function(cleanup) {
