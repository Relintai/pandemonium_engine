...
# Javascript editor with GDNative
scons tools=yes target=release_debug custom_modules_shared=no debug_symbols=no gdnative_enabled=yes threads_enabled=yes platform=javascript "$@"
