...
export PATH="${PANDEMONIUN_SDK_LINUX_X86_32}/bin:${BASE_PATH}"
...
export PATH="${PANDEMONIUN_SDK_LINUX_ARM64}/bin:${BASE_PATH}"
...
export PATH="${PANDEMONIUN_SDK_LINUX_ARM32}/bin:${BASE_PATH}"
